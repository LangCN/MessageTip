...
- (void)refreshButtonWidth
{
    ...
    //每次刷新，保证区域正确
    [_timeButton setBackgroundImage:[self imageWithColor:[UIColor greenColor] andSize:_timeButton.frame.size] forState:UIControlStateNormal];
